...
test_that("ll returns expected value", {
  ...
  expect_equal(round(ll_all(theta_rhybrid, fp_rhybrid, likdat), 4)[namev],
               c(anc = 81.3993, ancrt = 7.3509, hhs = 6.8466, incid = 0, rprior = 0))
  # Kinh not fix fp for rtrend, rspline
  # expect_equal(round(ll_all(theta_rspline, fp_rspline, likdat), 4),
  #              c(anc = 53.0482, ancrt = 1.6649, hhs = 4.4887,
  #                incid = 0, sibmx = 0, rprior = 0, incpen = 0))
  # expect_equal(round(ll_all(theta_rspline, fp_rspline_eq, likdat), 4),
  #              c(anc = 53.0482, ancrt = 1.6649, hhs = 4.4887, incid = 0, 
  #                sibmx = 0, rprior = -15.0062, incpen = 0))
  # expect_equal(round(ll_all(theta_rtrend, fp_rtrend, likdat), 4),
