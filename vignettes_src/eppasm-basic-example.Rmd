...
fp <- prepare_rhybrid(fp, rw_start = 2003, rw_trans = 5, rw_dk = 5)
...
bwfit$Urban <- fitmod(bw$Urban, eppmod = "rhybrid",
                      rw_start = 2003, rw_trans = 5, rw_dk = 5,
                      B0=1e3, B=1e2, opt_iter = 1:2*5, number_k=50)
bwfit$Rural <- fitmod(bw$Rural, eppmod = "rhybrid",
                      rw_start = 2005, rw_trans = 5, rw_dk = 5,
                      B0=1e3, B=1e2, opt_iter = 1:2*5, number_k=50)
```
