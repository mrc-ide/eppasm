...
## Single set of parameter inputs
...
fp <- prepare_rlogistic_rw(fp, rw_start = 2005)
...
bwfit$Urban <- fitmod(bw$Urban, eppmod = "rlogistic_rw", rw_start = 2005,
                      B0=1e3, B=1e2, opt_iter = 1:2*5, number_k=50)
bwfit$Rural <- fitmod(bw$Rural, eppmod = "rlogistic_rw", rw_start = 2005,
                      B0=1e3, B=1e2, opt_iter = 1:2*5, number_k=50)
```
